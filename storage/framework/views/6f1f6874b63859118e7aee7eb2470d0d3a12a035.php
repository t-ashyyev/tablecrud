 <form wire:submit.prevent='update(<?php echo e($studentId); ?>)' class="space-y-4" action="">
    ...
    <div class="space-y-2">
        <div class="flex items-center gap-2">
            ...
            <?php else: ?>
                <div class="avatar">
                    <div class="w-24 h-24 mask mask-hexagon">
                        <img class="w-full h-full object-cover" src="<?php echo e(asset('storage/' . $photoOld)); ?>">
                    </div>
                </div>
            <?php endif; ?>
...
</form><?php /**PATH C:\xampp\htdocs\wirecrud\resources\views/livewire/students/edit.blade.php ENDPATH**/ ?>