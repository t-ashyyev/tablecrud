...
} elseif ($_instance->childHasBeenRendered('l1882600774-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1882600774-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1882600774-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1882600774-0');
} else {
    $response = \Livewire\Livewire::mount('students.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1882600774-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('l1882600774-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1882600774-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1882600774-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1882600774-1');
} else {
    $response = \Livewire\Livewire::mount('students.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1882600774-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
</div><?php /**PATH C:\xampp\htdocs\tablecrud\resources\views/livewire/students/index.blade.php ENDPATH**/ ?>